...
You will not be scored on speed alone. We care about:
- Whether you found the root cause, not just the symptom
- Commit quality and git discipline
- Whether your feature integrates with the existing codebase patterns
